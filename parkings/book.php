...
if(mysqli_num_rows($result_cust)>0){
  echo '<div class="alert alert-warning" role="alert"><span class="glyphicon glyphicon-warning-sign"></span>  ALERTA!! Parece que tienes una solicitud pendiente sin aprobar aun, tranquil@, tu solicitud será aprobada pronto!! <span class="glyphicon glyphicon-warning-sign"></span> </div>';
}else{
